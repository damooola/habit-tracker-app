...
const HabitSchema = CollectionSchema(
  ...
  properties: {
    r'listOfCompletedDays': PropertySchema(
      id: 0,
      name: r'listOfCompletedDays',
...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.listOfCompletedDays.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.listOfCompletedDays);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.id = id;
  object.listOfCompletedDays = reader.readDateTimeList(offsets[0]) ?? [];
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysElementEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'listOfCompletedDays',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'listOfCompletedDays',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      listOfCompletedDaysLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByListOfCompletedDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'listOfCompletedDays');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations>
      listOfCompletedDaysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'listOfCompletedDays');
    });
  }
